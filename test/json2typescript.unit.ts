...
describe("JsonConvert unit tests", () => {
    ...
    describe("helper methods", () => {
        ...
        it("getClassPropertyMappingOptions()", () => {
            ...
            // Unmapped property should not return mapping, even though property is the same name as a mapped property
            // on another class
        ...
        describe("convertProperty()", () => {
            ...
            describe("expectedJsonType array", () => {
                ...
                it("should expand expected array type as needed without affecting original mapping", () => {
                    ...
                    expect((<any>jsonConvert).convertProperty(expectedJsonType, {
                        "0": "Andreas",
                        "1": "Joseph",
                        "2": "Albert",
